...
class ProductModel extends Model
{
    ...
    {
        return $this->field('think_product.*,name')->join('think_product_cate', 'think_product.cate_id = think_product_cate.id')->where($map)->page($Nowpage, $limits)->order('id desc')->select();
    }
