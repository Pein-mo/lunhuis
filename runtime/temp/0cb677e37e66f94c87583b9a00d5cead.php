<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\phpStudy\WWW\entss\public/../application/admin\view\news\add_news.html";i:1504884684;s:73:"D:\phpStudy\WWW\entss\public/../application/admin\view\public\header.html";i:1485259813;s:73:"D:\phpStudy\WWW\entss\public/../application/admin\view\public\footer.html";i:1485259813;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" name="add" id="add" method="post" action="add_news">

                        <div class="form-group">
                            <label class="col-sm-3 control-label">新闻标题：</label>
                            <div class="input-group col-sm-4">
                                <input id="title" type="text" class="form-control" name="title" placeholder="输入新闻标题">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">所属新闻分类：</label>
                            <div class="input-group col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <textarea type="text" rows="5" name="remark" id="remark" placeholder="输入新闻描述" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
        ...
        function complete(data){
            if(data.code == 1){
                layer.msg(data.msg, {icon: 6,time:1500,shade: 0.1}, function(index){
                    layer.close(index);
                    window.location.href="<?php echo url('news/news_list'); ?>";
                });
            }else{
