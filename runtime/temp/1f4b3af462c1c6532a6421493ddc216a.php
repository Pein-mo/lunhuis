<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\phpStudy\WWW\entss\public/../application/admin\view\ents\index_img.html";i:1504583187;s:73:"D:\phpStudy\WWW\entss\public/../application/admin\view\public\header.html";i:1485259813;s:73:"D:\phpStudy\WWW\entss\public/../application/admin\view\public\footer.html";i:1485259813;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div  class="col-sm-2" style="width: 100px">
                    <div class="input-group" >  
                        <a href="<?php echo url('add_index_img'); ?>"><button class="btn btn-outline btn-primary" type="button">添加轮播图</button></a> 
                    </div>
                </div>                                                                  
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.getJSON('<?php echo url("ents/index_img"); ?>', {
            page: curr || 1
