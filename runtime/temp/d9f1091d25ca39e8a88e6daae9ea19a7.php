<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpStudy\WWW\entss\public/../application/admin\view\config\index.html";i:1505145432;s:73:"D:\phpStudy\WWW\entss\public/../application/admin\view\public\header.html";i:1485259813;s:73:"D:\phpStudy\WWW\entss\public/../application/admin\view\public\footer.html";i:1485259813;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="panel-heading">                     
                            <div class="panel-options">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class=""><a data-toggle="tab" href="#tab-5" aria-expanded="false">关于我们配置</a></li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div id="tab-5" class="tab-pane">
                                    <form action="<?php echo url('save'); ?>" method="post" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-sm-4">                                              
                                                <input type="text" class="form-control" name="config[web_address]" value="<?php echo $config['web_address']; ?>">
                                                <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 公司地址</span>                                           
                                            </div>
                                        </div>  
                                        <div class="hr-line-dashed"></div>                                
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-sm-4">                                              
                                                <input type="text" class="form-control" name="config[web_landline]" value="<?php echo $config['web_landline']; ?>">
                                                <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 座机</span>                                           
                                            </div>
                                        </div>  
                                        <div class="hr-line-dashed"></div>                                
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-sm-4">                                              
                                                <input type="text" class="form-control" name="config[web_mobile]" value="<?php echo $config['web_mobile']; ?>">
                                                <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 手机</span>                                           
                                            </div>
                                        </div> 
                                        <div class="hr-line-dashed"></div>                                
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-sm-4">                                              
                                                ...
                                                <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 邮箱</span>                                           
                                            </div>
                                        </div>
                                        <div class="hr-line-dashed"></div>                          
				                        <div class="form-group">
				                            <label class="col-sm-2 control-label " for="myEditor">关于我们：</label>
				                            <div class="input-group col-sm-9">
				                                ...
				                                <textarea name="config[web_about_us]" style="width:90%" id="myEditor"><?php echo $config['web_about_us']; ?></textarea>
